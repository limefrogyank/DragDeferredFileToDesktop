...
using DragDeferredFileToDesktop.Helpers;
...
namespace DragDeferredFileToDesktop.ViewModels
{
    public class ShellViewModel : ViewModelBase
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(new ShellNavigationItem("Shell_StorageFileFromProject".GetLocalized(), Symbol.Document, typeof(StorageFileFromProjectViewModel).FullName));
            _primaryItems.Add(new ShellNavigationItem("Shell_StorageFileRemoteUrlDeferred".GetLocalized(), Symbol.Document, typeof(StorageFileRemoteUrlDeferredViewModel).FullName));
            _primaryItems.Add(new ShellNavigationItem("Shell_StorageFileHack".GetLocalized(), Symbol.Document, typeof(StorageFileHackViewModel).FullName));
        }
